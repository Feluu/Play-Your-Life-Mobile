...
public class CarsListActivity extends AppCompatActivity {
    ...
    private void addCarsToRecycler() {
        ...
        carsList.add(new ListModel(intToString(R.string.comet_2_name), intToString(R.string.comet_2_vmax), intToString(R.string.comet_2_vmaxfmk), intToString(R.string.comet_2_tax), intToString(R.string.comet_2_reset), R.drawable.comet2));
